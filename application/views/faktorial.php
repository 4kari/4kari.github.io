...
<body >
  ...
  <h4 class="mt-3">Perpangkatan</h4>
    <p class="mb-4">Pada halaman ini dapat dilakukan perhitungan faktorial, isikan nilai awal untuk dihitung faktorialnya</p> 
    <form method="POST" action="<?= base_url('faktorial/hitung')?>">                        
      <div class="card shadow-sm mb-4">
        ...
        <div class="card-footer">
          ...
          <div class="row">
            <div class="col-sm">
              <a class="btn btn-primary" href="<?=base_url('faktorial/showtable')?>">show all data</a>
